...
const dummyTestimonials = [
  {
    ...
    mentorName: "Dr. Sita Rai",
    mentorCountryCode: "NP",
    mentorJobTitle: "Data Scientist",
    mentorCompany: "Netflix",
    mentorSessions: 278,
    mentorReviews: 67,
    reviewText: "Great chat with Dr. Sita! She helped me rethink about machine learning metrics when working on my capstone project. I liked that she had research papers & resources ready to share. The fact that she showed openness for future conversations is also amazing.",
    reviewerImage: "/images/reviewer1.jpg",
    reviewerName: "Arjun Karki",
    reviewerRole: "Computer Engineering Student",
    reviewerCompany: "Kathmandu University",
  },
  {
    mentorImage: "/images/mentor2.jpg",
    mentorName: "Rahul Thapa",
    mentorCountryCode: "US",
    mentorJobTitle: "Product Manager",
    mentorCompany: "Microsoft",
    mentorSessions: 189,
    mentorReviews: 10,
    reviewText: "Rahul is very knowledgeable, informative and super helpful Product Manager who has great ideas! Thank you Rahul for your advice, dedication to mentoring aspiring PMs and willingness to share your knowledge & experiences!!",
    reviewerImage: "/images/reviewer2.jpg",
    reviewerName: "Sita Poudel",
    reviewerRole: "Business Student",
    reviewerCompany: "Kathmandu University",
  },
  {
    mentorImage: "/images/mentor4.jpg",
    mentorName: "Maya Gurung",
    mentorCountryCode: "NP",
    mentorJobTitle: "UX Designer",
    mentorCompany: "Airbnb",
    mentorSessions: 118,
    mentorReviews: 23,
    reviewText: "The conversation with Maya completely blew me out of the water. Maya is an amazing mentor and even offered to do some portfolio reviews with me. I can't wait to book another session with her. You rock, Maya!",
    reviewerImage: "/images/reviewer3.jpg",
    reviewerName: "Kiran Adhikari",
