...
export const mockMentorProfiles: MentorProfile[] = [
  {
    ...
    bio: "I'm Priya! With 10+ years of experience in full-stack development, I specialize in bridging the gap between technology and user needs.",
    fullBio: "I'm Priya! With 10+ years of experience in full-stack development, I specialize in bridging the gap between technology and user needs. As a seasoned engineer at Google, I've worked on large-scale distributed systems, led cross-functional teams, and mentored dozens of junior engineers.\n\nI'm passionate about helping students and early-career professionals transition into tech, prepare for technical interviews, and navigate their career growth. Whether you're working on system design, coding skills, or career strategy, I'm here to help you succeed.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: 'Great chat with Priya! She helped me rethink about system design when working on my capstone project. I liked that she had resources ready to share. The fact that she showed openness for future conversations is also amazing.',
        date: '2 weeks ago',
        helpful: 12,
      },
      {
        ...
        rating: 5,
        comment: 'Priya is very knowledgeable, informative and super helpful mentor who has great ideas! Thank you for your advice, dedication to mentoring and willingness to share your knowledge & experiences!!',
        date: '1 month ago',
        helpful: 8,
      },
    ],
